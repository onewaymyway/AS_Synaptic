package oneway.nn {
	...
	public class Trainer {
		...
		public function train(set, options) {
			var error = 1;
		...
		public function trainAsync(set, options) {
		...
		public function _trainSet(set, currentRate, costFunction) {
			var errorSum = 0;
		...
		public function test(set, options) {
			var error = 0;
		...
		public function workerTrain(set, callback, options, suppressWarning) {
			if (!suppressWarning) {
		...
		public function XOR(options) {
			if (this.network.inputs() != 2 || this.network.outputs() != 1)
				throw new Error('Incompatible network (2 inputs, 1 output)');
			
			var defaults = {iterations: 100000, log: false, shuffle: true, cost: Trainer.cost.MSE};
		...
		public function timingTask(options) {
